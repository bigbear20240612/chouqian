...
#### 4. 橙色和青色主题问题
- **问题**: 用户反馈橙色/黄色太刺眼，影响视觉体验
- **根本原因**:
  - `app/layout.tsx` 中的橙色背景容器包裹了所有页面
  - 项目卡片和加载器使用了橙色/青色
- **解决**:
  - 移除 `app/layout.tsx` 中的橙色背景 div
  - 将所有页面背景改为蓝色渐变 (`from-slate-50 via-white to-blue-50`)
  - 项目卡片颜色统一改为蓝色/靛蓝色/紫色系
  - 所有加载器从橙色改为蓝色
  - 特性卡片图标也统一为蓝色系
- **提交**: b4f3eb6
- **状态**: ✅ 已解决并部署
...
### v1.2.0 (2026-03-07) - 颜色主题优化

#### 完全移除橙色/青色
- ✅ 移除 layout.tsx 中的橙色背景容器
- ✅ 所有页面背景统一使用蓝色渐变
- ✅ 项目卡片颜色改为蓝色/靛蓝色/紫色系
- ✅ 所有加载器从橙色改为蓝色
- ✅ 特性卡片图标统一为蓝色主题
